...
exports.run = (bot, message, args) => {
    ...
    let argsJunto = message.content.split(" ").slice(1).join(' ')
        ...
        if (message.guild === null) {
            ...
            serverinfo.addField('ID do dono', message.guild.owner.id, true);
            serverinfo.addField('Região do servidor', message.guild.region, true);
            serverinfo.addField('Dono', message.guild.owner, true);
            ...
            serverinfo.addField('Voce entrou aqui em', moment(message.member.joinedAt).format('LL'));
            serverinfo.addField('Entrei aqui em', moment(bot.user.joinedAt).format('LL'));
